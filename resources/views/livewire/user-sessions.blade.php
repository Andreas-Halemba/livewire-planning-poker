                ...
                <div class="shadow-sm card card-sm bg-base-100 text-base-content">
                    <div class="card-body">
                        ...
                        <div class="flex gap-2 card-actions">
                            <button class="w-full btn btn-primary btn-sm btn-outline"
                                wire:click.prevent="joinSession('{{ $session->invite_code }}')">Join</button>
                            <button class="w-full btn btn-error btn-sm btn-outline"
                                wire:click.prevent="leaveSession('{{ $session->id }}')">Remove</button>
                        </div>
                    </div>
                </div>
            @endforeach
