...
@else
    <div class="space-y-6">
        ...
        <button wire:click="refreshAllJiraIssues" class="btn btn-sm btn-outline w-full gap-2"
            @disabled($jiraRefreshing) wire:loading.attr="disabled" wire:target="refreshAllJiraIssues">
            <svg wire:loading.remove wire:target="refreshAllJiraIssues" class="w-4 h-4" fill="none"
                stroke="currentColor" viewBox="0 0 24 24">
                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2"
                    d="M4 4v6h6M20 20v-6h-6M20 8a8 8 0 00-14.66-3.34M4 16a8 8 0 0014.66 3.34" />
            </svg>
            <span wire:loading.remove wire:target="refreshAllJiraIssues">Importierte Tickets aus Jira
                aktualisieren</span>
