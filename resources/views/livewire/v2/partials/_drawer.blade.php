...
<div class="drawer drawer-end z-50" x-data @keydown.escape.window="$wire.set('drawerOpen', false)">
        ...
        <div class="bg-base-100 min-h-full w-[80vw] max-w-4xl p-6 shadow-xl">
            ...
            <div class="grid grid-cols-2 gap-2 mb-6">
                ...
                <button wire:click="switchTab('jira')"
                    ...
                    {{-- Normal Icon --}}
                    <svg wire:loading.remove wire:target="switchTab('jira')" class="w-5 h-5" viewBox="0 0 24 24"
                        fill="currentColor">
                        <path
                    ...
                    {{-- Loading Spinner --}}
                    <span wire:loading wire:target="switchTab('jira')"
