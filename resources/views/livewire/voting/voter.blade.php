                ...
                <div class="flex flex-col gap-2">
                    @foreach($upcomingIssues as $issue)
                        <div class="flex items-center justify-between p-3 bg-base-200 rounded-lg border border-base-300">
                            ...
                            @if($loop->first)
                                <span class="text-xs font-semibold px-2 py-1 bg-warning/20 text-warning rounded uppercase ml-2 flex-shrink-0">
                                    Nächstes
                                </span>
                            @else
                                <span class="text-xs font-semibold px-2 py-1 bg-base-300 text-base-content/70 rounded uppercase ml-2 flex-shrink-0">
                                    Wartend
                                </span>
                            @endif
                        </div>
